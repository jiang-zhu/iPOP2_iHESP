...
!-----------------------------------------------------------------------
   ...
   logical (kind=log_kind) ::  &
      ...
      wiso_on, nd_on, abio_dic_dic14_on, ciso_on
...
!-----------------------------------------------------------------------
   ...
   if (abio_dic_dic14_on) then
      call abio_dic_dic14_reset(  &
         TRACER_NEW(:,:,:,abio_dic_dic14_ind_begin:abio_dic_dic14_ind_end), bid)
   end if
