module POP_CplIndices
  ...
  integer :: index_x2o_Foxx_rofl_16O       ! H216O liq river runoff flux            (kg/m2/s)
  integer :: index_x2o_Foxx_rofi_16O       ! H216O ice river runoff flux            (kg/m2/s)
  integer :: index_x2o_Foxx_rofl_18O       ! H218O liq river runoff flux            (kg/m2/s)
  integer :: index_x2o_Foxx_rofi_18O       ! H218O ice river runoff flux            (kg/m2/s)
  integer :: index_x2o_Foxx_rofl_HDO       ! HDO   liq river runoff flux            (kg/m2/s)
  integer :: index_x2o_Foxx_rofi_HDO       ! HDO   ice river runoff flux            (kg/m2/s)
...
contains
  ...
  subroutine POP_CplIndicesSet( )
    ...
    index_x2o_Foxx_rofl_16O = mct_avect_indexra(x2o,'Foxx_rofl_16O',perrWith='quiet')
    index_x2o_Foxx_rofi_16O = mct_avect_indexra(x2o,'Foxx_rofi_16O',perrWith='quiet')
    index_x2o_Foxx_rofl_18O = mct_avect_indexra(x2o,'Foxx_rofl_18O',perrWith='quiet')
    index_x2o_Foxx_rofi_18O = mct_avect_indexra(x2o,'Foxx_rofi_18O',perrWith='quiet')
    index_x2o_Foxx_rofl_HDO = mct_avect_indexra(x2o,'Foxx_rofl_HDO',perrWith='quiet')
    index_x2o_Foxx_rofi_HDO = mct_avect_indexra(x2o,'Foxx_rofi_HDO',perrWith='quiet')
    index_x2o_Fioi_meltw_16O= mct_avect_indexra(x2o,'Fioi_meltw_16O',perrWith='quiet')
    index_x2o_Fioi_meltw_18O= mct_avect_indexra(x2o,'Fioi_meltw_18O',perrWith='quiet')
    index_x2o_Fioi_meltw_HDO= mct_avect_indexra(x2o,'Fioi_meltw_HDO',perrWith='quiet')
