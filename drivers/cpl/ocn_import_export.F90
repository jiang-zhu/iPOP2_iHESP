...
!-----------------------------------------------------------------------
   if (index_x2o_Faxa_prec_16O > 0) then
      ...
      do iblock = 1, nblocks_clinic
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Faxa_prec_16O,n)  !h2_16o precip 
         enddo
         enddo
      enddo
      call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Faxa_prec_18O > 0) then
      ...
      do iblock = 1, nblocks_clinic
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Faxa_prec_18O,n)  !h2_18o precip 
         enddo
         enddo
       enddo
       call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Faxa_prec_HDO > 0) then
       ...
       do iblock = 1, nblocks_clinic
          ...
          do i=this_block%ib,this_block%ie
             n = n + 1
             WORK1(i,j,iblock) = x2o(index_x2o_Faxa_prec_HDO,n)  !h2_hdo precip 
          enddo
          enddo
       enddo
       call POP_HaloUpdate(WORK1,POP_haloClinic,          &
...
!-----------------------------------------------------------------------
   if (index_x2o_Foxx_evap_16O > 0) then
      ...
      do iblock = 1, nblocks_clinic
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Foxx_evap_16O,n)  !h2_16o evap 
         enddo
         enddo
      enddo
      call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Foxx_evap_18O > 0) then
      ...
      do iblock = 1, nblocks_clinic
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Foxx_evap_18O,n)  !h2_18o evap 
         enddo
         enddo
       enddo
       call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Foxx_evap_HDO > 0) then
       ...
       do iblock = 1, nblocks_clinic
          ...
          do i=this_block%ib,this_block%ie
             n = n + 1
             WORK1(i,j,iblock) = x2o(index_x2o_Foxx_evap_HDO,n)  !h2_hdo evap 
          enddo
          enddo
       enddo
       call POP_HaloUpdate(WORK1,POP_haloClinic,          &
...
!-----------------------------------------------------------------------
   if (index_x2o_Fioi_meltw_16O > 0) then
      ...
      do iblock = 1, nblocks_clinic
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Fioi_meltw_16O,n)  !h2_16o evap 
         enddo
         enddo
      enddo
      call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Fioi_meltw_18O > 0) then
      ...
      do iblock = 1, nblocks_clinic
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Fioi_meltw_18O,n)  !h2_18o evap 
         enddo
         enddo
       enddo
       call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Fioi_meltw_HDO > 0) then
       ...
       do iblock = 1, nblocks_clinic
          ...
          do i=this_block%ib,this_block%ie
             n = n + 1
             WORK1(i,j,iblock) = x2o(index_x2o_Fioi_meltw_HDO,n)  !h2_hdo evap 
          enddo
          enddo
       enddo
       call POP_HaloUpdate(WORK1,POP_haloClinic,          &
...
!-----------------------------------------------------------------------
   if (index_x2o_Foxx_rofl_16O > 0) then
      ...
      do iblock = 1, nblocks_clinic
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Foxx_rofl_16O,n)
         enddo
         enddo
      enddo
      call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Foxx_rofi_16O > 0) then
      ...
      do iblock = 1, nblocks_clinic
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Foxx_rofi_16O,n)
         enddo
         enddo
      enddo
      call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Foxx_rofl_18O > 0) then
      n = 0
      do iblock = 1, nblocks_clinic
         this_block = get_block(blocks_clinic(iblock),iblock)
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Foxx_rofl_18O,n)
         enddo
         enddo
      enddo
      call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Foxx_rofi_18O > 0) then
      n = 0
      do iblock = 1, nblocks_clinic
         this_block = get_block(blocks_clinic(iblock),iblock)
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Foxx_rofi_18O,n)
         enddo
         enddo
      enddo
      call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Foxx_rofl_HDO > 0) then
      n = 0
      do iblock = 1, nblocks_clinic
         this_block = get_block(blocks_clinic(iblock),iblock)
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Foxx_rofl_HDO,n)
         enddo
         enddo
      enddo
      call POP_HaloUpdate(WORK1,POP_haloClinic,          &
   ...
   if (index_x2o_Foxx_rofi_HDO > 0) then
      n = 0
      do iblock = 1, nblocks_clinic
         this_block = get_block(blocks_clinic(iblock),iblock)
         ...
         do i=this_block%ib,this_block%ie
            n = n + 1
            WORK1(i,j,iblock) = x2o(index_x2o_Foxx_rofi_HDO,n)
         enddo
         enddo
      enddo
      call POP_HaloUpdate(WORK1,POP_haloClinic,          &
